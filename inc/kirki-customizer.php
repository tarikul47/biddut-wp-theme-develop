...
function header_side_section()
{
    ...
    new \Kirki\Field\Text(
        [
            ...
            'label'    => esc_html__('Contacts Lable', 'biddut'),
            'section'  => 'header_side_section',
    ...
    new \Kirki\Field\Text(
        [
            'settings' => 'header_side_contacts_address',
            'label'    => esc_html__('Contacts Address', 'biddut'),
            'section'  => 'header_side_section',
            'default'  => esc_html__('734 H, Bryan Burlington, NC 27215', 'biddut'),
            'priority' => 10,
        ]
    ...
    new \Kirki\Field\Text(
        [
            'settings' => 'header_side_contacts_address_url',
            'label'    => esc_html__('Contacts Address URL', 'biddut'),
            'section'  => 'header_side_section',
            'default'  => esc_html__('https://www.google.com/maps/@23.8223586,90.3661283,15z', 'biddut'),
            'priority' => 10,
        ]
    );
    new \Kirki\Field\Text(
        [
            ...
            'label'    => esc_html__('Contact Email', 'biddut'),
            'section'  => 'header_side_section',
            'default'  => esc_html__('biddut@support.com', 'biddut'),
            'priority' => 10,
        ]
    ...
    new \Kirki\Field\Text(
        [
            ...
            'label'    => esc_html__('Contact Phone', 'biddut'),
            'section'  => 'header_side_section',
            'default'  => esc_html__('8801310-069824', 'biddut'),
            'priority' => 10,
        ]
    );
    new \Kirki\Field\Text(
        [
            'settings' => 'header_mailchimp_shortcode',
            'label'    => esc_html__('MailChimp Shortcode', 'biddut'),
            'section'  => 'header_side_section',
...
function header_social_section()
{
    ...
    new \Kirki\Section(
        ...
        [
            ...
            'description' => esc_html__('Keep blank for Social hide.', 'biddut'),
            'panel'       => 'panel_id',
            'priority'    => 120,
        ]
    );
...
function header_logo_section()
{
    ...
    new \Kirki\Field\Image(
        [
            ...
            'label'       => esc_html__('Primary Header Logo / White', 'biddut'),
    ...
    new \Kirki\Field\Image(
        [
            ...
            'label'       => esc_html__('Header Search Logo / White', 'biddut'),
            'description' => esc_html__('You can see it after search button click', 'biddut'),
            'section'     => 'header_logo_section',
            'default'     => get_template_directory_uri() . '/assets/img/logo/white-logo.png',
        ]
    );
