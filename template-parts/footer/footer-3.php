...
<footer class="tp-footer-area-3  p-relative z-index-1 pt-120" data-bg-color="#16243E">
    <div class="tp-footer-bg-shape-3">
        <img class="shape-1" src="<?php echo get_template_directory_uri(); ?>/assets/img/footer/home-3/shape-1.png" alt="">
        <img class="shape-2" src="<?php echo get_template_directory_uri(); ?>/assets/img/footer/home-3/shape-2.png" alt="">
    </div>
